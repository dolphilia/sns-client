...
import { Route as MyLikesRouteImport } from './routes/my-likes'
...
const MyLikesRoute = MyLikesRouteImport.update({
  id: '/my-likes',
  path: '/my-likes',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface RootRouteChildren {
  ...
  MyLikesRoute: typeof MyLikesRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/my-likes': {
      ...
      path: '/my-likes'
      fullPath: '/my-likes'
      preLoaderRoute: typeof MyLikesRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/login': {
      id: '/login'
